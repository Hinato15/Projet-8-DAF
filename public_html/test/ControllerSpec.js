...
describe('controller', function () {
    ...
    it('should show entries on start-up', function () {
        var todo = {id: 562853, title: 'my todo', completed: false};
        setUpModel([todo]);
    ...
    it('should highlight "Active" filter when switching to active view', function () {
        var todo = [{id: 42, title: 'my todo', completed: false}, {id: 43, title: 'my todo', completed: true}];
        setUpModel(todo);
    ...
    describe('new todo', function () {
        it('should add a new todo to the model', function () {
            ...
            view.trigger('newTodo', 'my todo 2');

            expect(model.create).toHaveBeenCalledWith('my todo 2', jasmine.any(Function));
        });
